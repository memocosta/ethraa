(function($) {
    ...
    let calc = (val) => {
        ...
        let endDateAward = (startDate, endData, discountDaysFromEnd = 0, salery, saleryPlus = 0, endReason, discountInsurance = 0) => {
            ...
            var now = new Date(endData);
            var today = new Date(now.getYear(), now.getMonth(), now.getDate());
            var yearNow = now.getYear();
            var monthNow = now.getMonth();
            var dateNow = now.getDate();
            var fullYearNow = now.getFullYear();
            var dob = new Date(startDate.substring(6, 10), startDate.substring(0, 2) - 1, startDate.substring(3, 5));
        ...
        let calcLawDate = (startDate, endDate, discountDaysBefore20 = 0, discountDaysAfter20 = 0, vacationDaysPaid = 0, salery, additionVacation = 30) => {
            ...
            if (new Date(date_20_02_2010).getTime() > new Date(startDate).getTime()) {
                var now = new Date(date_20_02_2010);
                var today = new Date(now.getYear(), now.getMonth(), now.getDate());
                var yearNow = now.getYear();
                var monthNow = now.getMonth();
                var dateNow = now.getDate();
            ...
            if (new Date(date_20_02_2010).getTime() < new Date(endDate).getTime()) {
                ...
                var dateNow = now.getDate();
                var fullYearNow = now.getFullYear();
                var dob = daysBefore20 ? new Date(date_20_02_2010.substring(6, 10), date_20_02_2010.substring(0, 2) - 1, date_20_02_2010.substring(3, 5)) : new Date(startDate.substring(6, 10), startDate.substring(0, 2) - 1, startDate.substring(3, 5));
                var yearDob = dob.getYear();
                var monthDob = dob.getMonth();
                var dateDob = dob.getDate();
                var fullYearDob = dob.getFullYear();
            ...
            let totalVacationDays = (((_a = daysBefore20 === null || daysBefore20 === void 0 ? void 0 : daysBefore20.date) === null || _a === void 0 ? void 0 : _a.totalDays) || 0) + (((_b = daysAfter20 === null || daysAfter20 === void 0 ? void 0 : daysAfter20.date) === null || _b === void 0 ? void 0 : _b.totalDays) || 0);
