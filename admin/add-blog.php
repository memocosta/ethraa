<?php 
    include 'header.php';
    $blog = (isset($_GET['id'])) ? getRow($_GET['id'], 'blog') : getRow(1, 'blog');
?>
...
<div role="main" class="main">
    <section class="page-header page-header-color page-header-quaternary page-header-more-padding custom-page-header">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                <?php $value = isset($_GET['id']) ? 'تعديل خبر' : 'أضافة خبر'; ?>
            ...
            <div class="col-md-12">
                ...
                <form id="contactForm" class="custom-contact-form-style-1" action="<?php echo $value; ?>" method="POST">
                    <?php if (isset($_GET['id'])) { ?>
                        <input type="hidden" value="<?php echo $blog['id']; ?>" name="row_id" required/>
                    <?php } ?>
                    <input type="hidden" value="blog" name="link" required/>
                    <input type="hidden" value="blog" name="table" required/>
					<div class="row">
						<div class="form-group">
							<div class="col-md-12">
								<div class="custom-input-box">
									<label for="title">الاسم </label>
                                    <?php $value = isset($_GET['id']) ? 'value="'.$blog['title'].'"' : ''; ?>
						...
						<div class="form-group">
							<div class="col-md-12">
								<div class="custom-input-box">
                                    ...
                                    <?php $value = isset($_GET['id']) ? $blog['body_short'] : ''; ?>
						...
						<div class="form-group">
							<div class="col-md-12">
								<div class="custom-input-box">
                                    ...
                                    <?php $value = isset($_GET['id']) ? $blog['body'] : ''; ?>
